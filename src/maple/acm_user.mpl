...
# Maple programs in acm??.mpl (version 16 and beyond).
...
#SO5CG_directory:="/home/trevor/progs/so5/data/new_order/":
#SO5CG_directory:="/home/trevor/progs/so5/data/new_split/":
#SO5CG_directory:="/home/trevor/progs/so5/data/so5cg-data/":
SO5CG_directory:="/Users/djrowe/Datafiles/MapleCodes/acm16/so5cg-data/":
...
# 2 gives the ACM parity basis (0.0 is a plcefiller, the third
...
ACM_set_rat_fit(10.0,2,0,1,1,0):
...
ACM_set_transition(quad_op,int_amp_fun,quad_rat_fun,0):   #ver 14
ACM_set_sft_fun(sqrt,0):
ACM_set_rat_format(quad_rat_fmat,quad_rat_flist,
                   quad_amp_fmat,quad_amp_flist,0):
...
######################################################################
###  End of user-specified settings file.
######################################################################
